...
parser.add_argument('-s', '--samples', help='Number of samples',
                    default=4000, dest="samples", type=int)
...
parser.add_argument('-o', '--optim', help='1 to select SGD, 2 to select Adam',
                    dest='optimizer', default=1, type=int)
    ...
    def sampler(self):
        ...
        for i in range(self.samples - 1):
            ...
            if(self.use_langevin_gradients and lx < self.l_prob):
                ...
                w_prop_gd = copy.deepcopy(self.rnn.langevin_gradient(
        ...
        return(pos_w, rmse_train, step_wise_rmse_train, rmse_test, step_wise_rmse_test, likeh_list)
...
def main():
    ...
    for j in [2, 5, 3]:
        ...
        [pos_w, rmse_train, indiv_rmse_train, rmse_test,
            indiv_rmse_test, likelihood] = mcmc.sampler()
